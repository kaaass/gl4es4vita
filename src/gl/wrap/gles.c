...
EXPORT void APIENTRY_GL4ES gl4es_glAlphaFunc(GLenum func, GLclampf ref) {
...
EXPORT void APIENTRY_GL4ES gl4es_glAlphaFuncx(GLenum func, GLclampx ref) {
...
EXPORT void APIENTRY_GL4ES gl4es_glBindBuffer(GLenum target, GLuint buffer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glBufferData(GLenum target, GLsizeiptr size, const GLvoid * data, GLenum usage) {
...
EXPORT void APIENTRY_GL4ES gl4es_glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid * data) {
...
#endif
#ifndef skip_glClear
EXPORT void APIENTRY_GL4ES gl4es_glClear(GLbitfield mask) {
    LOAD_GLES(glClear);
...
EXPORT void APIENTRY_GL4ES gl4es_glClearColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
...
EXPORT void APIENTRY_GL4ES gl4es_glClearColorx(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha) {
...
EXPORT void APIENTRY_GL4ES gl4es_glClearDepthx(GLclampx depth) {
...
EXPORT void APIENTRY_GL4ES gl4es_glClearStencil(GLint s) {
...
EXPORT void APIENTRY_GL4ES gl4es_glClipPlanex(GLenum plane, const GLfixed * equation) {
...
EXPORT void APIENTRY_GL4ES gl4es_glColor4ub(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha) {
...
EXPORT void APIENTRY_GL4ES gl4es_glColor4x(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha) {
    LOAD_GLES(glColor4x);
...
EXPORT void APIENTRY_GL4ES gl4es_glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) {
...
EXPORT void APIENTRY_GL4ES gl4es_glColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCompileShader(GLuint shader) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid * data) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid * data) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
...
EXPORT GLuint APIENTRY_GL4ES gl4es_glCreateProgram() {
...
EXPORT GLuint APIENTRY_GL4ES gl4es_glCreateShader(GLenum type) {
...
EXPORT void APIENTRY_GL4ES gl4es_glCullFace(GLenum mode) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDeleteBuffers(GLsizei n, const GLuint * buffer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDeleteShader(GLuint shader) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDepthRangef(GLclampf Near, GLclampf Far) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDepthRangex(GLclampx Near, GLclampx Far) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDisableClientState(GLenum array) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDrawTexf(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height) {
...
EXPORT void APIENTRY_GL4ES gl4es_glDrawTexi(GLint x, GLint y, GLint z, GLint width, GLint height) {
...
EXPORT void APIENTRY_GL4ES gl4es_glEnableClientState(GLenum array) {
...
EXPORT void APIENTRY_GL4ES gl4es_glFinish() {
    LOAD_GLES(glFinish);
...
#endif
#ifndef skip_glFlush
EXPORT void APIENTRY_GL4ES gl4es_glFlush() {
    LOAD_GLES(glFlush);
...
EXPORT void APIENTRY_GL4ES gl4es_glFogCoordPointer(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
#endif
#ifndef skip_glFogx
EXPORT void APIENTRY_GL4ES gl4es_glFogx(GLenum pname, GLfixed param) {
    LOAD_GLES(glFogx);
...
#endif
#ifndef skip_glFogxv
EXPORT void APIENTRY_GL4ES gl4es_glFogxv(GLenum pname, const GLfixed * params) {
    LOAD_GLES(glFogxv);
...
EXPORT void APIENTRY_GL4ES gl4es_glFrontFace(GLenum mode) {
...
EXPORT void APIENTRY_GL4ES gl4es_glFrustumf(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat Near, GLfloat Far) {
...
EXPORT void APIENTRY_GL4ES gl4es_glFrustumx(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed Near, GLfixed Far) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGenBuffers(GLsizei n, GLuint * buffer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetAttachedShaders(GLuint program, GLsizei maxCount, GLsizei * count, GLuint * obj) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetBooleanv(GLenum pname, GLboolean * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetBufferParameteriv(GLenum target, GLenum pname, GLint * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetClipPlanef(GLenum plane, GLfloat * equation) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetClipPlanex(GLenum plane, GLfixed * equation) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetFixedv(GLenum pname, GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetLightfv(GLenum light, GLenum pname, GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetLightxv(GLenum light, GLenum pname, GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetMaterialfv(GLenum face, GLenum pname, GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetMaterialxv(GLenum face, GLenum pname, GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetProgramBinary(GLuint program, GLsizei bufSize, GLsizei * length, GLenum * binaryFormat, GLvoid * binary) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei * length, GLchar * infoLog) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype, GLint * range, GLint * precision) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetShaderSource(GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * source) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetShaderiv(GLuint shader, GLenum pname, GLint * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexEnvfv(GLenum target, GLenum pname, GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexEnviv(GLenum target, GLenum pname, GLint * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexEnvxv(GLenum target, GLenum pname, GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexParameterfv(GLenum target, GLenum pname, GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexParameteriv(GLenum target, GLenum pname, GLint * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetTexParameterxv(GLenum target, GLenum pname, GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetUniformfv(GLuint program, GLint location, GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glGetUniformiv(GLuint program, GLint location, GLint * params) {
...
#endif
#ifndef skip_glHint
EXPORT void APIENTRY_GL4ES gl4es_glHint(GLenum target, GLenum mode) {
    LOAD_GLES(glHint);
...
EXPORT GLboolean APIENTRY_GL4ES gl4es_glIsBuffer(GLuint buffer) {
...
EXPORT GLboolean APIENTRY_GL4ES gl4es_glIsShader(GLuint shader) {
...
EXPORT GLboolean APIENTRY_GL4ES gl4es_glIsTexture(GLuint texture) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLightModelf(GLenum pname, GLfloat param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLightModelfv(GLenum pname, const GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLightModelx(GLenum pname, GLfixed param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLightModelxv(GLenum pname, const GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLightf(GLenum light, GLenum pname, GLfloat param) {
    LOAD_GLES(glLightf);
...
EXPORT void APIENTRY_GL4ES gl4es_glLightfv(GLenum light, GLenum pname, const GLfloat * params) {
    LOAD_GLES(glLightfv);
...
EXPORT void APIENTRY_GL4ES gl4es_glLightx(GLenum light, GLenum pname, GLfixed param) {
    LOAD_GLES(glLightx);
...
EXPORT void APIENTRY_GL4ES gl4es_glLightxv(GLenum light, GLenum pname, const GLfixed * params) {
    LOAD_GLES(glLightxv);
...
EXPORT void APIENTRY_GL4ES gl4es_glLineWidth(GLfloat width) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLineWidthx(GLfixed width) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLoadMatrixx(const GLfixed * m) {
...
EXPORT void APIENTRY_GL4ES gl4es_glLogicOp(GLenum opcode) {
    LOAD_GLES(glLogicOp);
...
EXPORT void APIENTRY_GL4ES gl4es_glMaterialf(GLenum face, GLenum pname, GLfloat param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glMaterialx(GLenum face, GLenum pname, GLfixed param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glMaterialxv(GLenum face, GLenum pname, const GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glMultMatrixx(const GLfixed * m) {
...
EXPORT void APIENTRY_GL4ES gl4es_glMultiTexCoord4x(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q) {
...
EXPORT void APIENTRY_GL4ES gl4es_glNormal3x(GLfixed nx, GLfixed ny, GLfixed nz) {
...
EXPORT void APIENTRY_GL4ES gl4es_glNormalPointer(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glOrthof(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat Near, GLfloat Far) {
    LOAD_GLES(glOrthof);
...
EXPORT void APIENTRY_GL4ES gl4es_glOrthox(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed Near, GLfixed Far) {
    LOAD_GLES(glOrthox);
...
EXPORT void APIENTRY_GL4ES gl4es_glPointParameterx(GLenum pname, GLfixed param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glPointParameterxv(GLenum pname, const GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glPointSizePointerOES(GLenum type, GLsizei stride, const GLvoid * pointer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glPointSizex(GLfixed size) {
...
EXPORT void APIENTRY_GL4ES gl4es_glPolygonOffset(GLfloat factor, GLfloat units) {
...
EXPORT void APIENTRY_GL4ES gl4es_glPolygonOffsetx(GLfixed factor, GLfixed units) {
...
EXPORT void APIENTRY_GL4ES gl4es_glProgramBinary(GLuint program, GLenum binaryFormat, const GLvoid * binary, GLint length) {
...
EXPORT void APIENTRY_GL4ES gl4es_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid * pixels) {
...
EXPORT void APIENTRY_GL4ES gl4es_glReleaseShaderCompiler() {
...
EXPORT void APIENTRY_GL4ES gl4es_glRotatex(GLfixed angle, GLfixed x, GLfixed y, GLfixed z) {
    LOAD_GLES(glRotatex);
...
EXPORT void APIENTRY_GL4ES gl4es_glSampleCoverage(GLclampf value, GLboolean invert) {
...
EXPORT void APIENTRY_GL4ES gl4es_glSampleCoveragex(GLclampx value, GLboolean invert) {
...
EXPORT void APIENTRY_GL4ES gl4es_glScalex(GLfixed x, GLfixed y, GLfixed z) {
    LOAD_GLES(glScalex);
...
EXPORT void APIENTRY_GL4ES gl4es_glShadeModel(GLenum mode) {
...
EXPORT void APIENTRY_GL4ES gl4es_glShaderBinary(GLsizei n, const GLuint * shaders, GLenum binaryformat, const GLvoid * binary, GLsizei length) {
...
EXPORT void APIENTRY_GL4ES gl4es_glShaderSource(GLuint shader, GLsizei count, const GLchar * const * string, const GLint * length) {
...
EXPORT void APIENTRY_GL4ES gl4es_glStencilFunc(GLenum func, GLint ref, GLuint mask) {
...
EXPORT void APIENTRY_GL4ES gl4es_glStencilFuncSeparate(GLenum face, GLenum func, GLint ref, GLuint mask) {
...
EXPORT void APIENTRY_GL4ES gl4es_glStencilMask(GLuint mask) {
...
EXPORT void APIENTRY_GL4ES gl4es_glStencilOp(GLenum fail, GLenum zfail, GLenum zpass) {
...
EXPORT void APIENTRY_GL4ES gl4es_glStencilOpSeparate(GLenum face, GLenum sfail, GLenum zfail, GLenum zpass) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexCoordPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnvf(GLenum target, GLenum pname, GLfloat param) {
    LOAD_GLES(glTexEnvf);
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnvfv(GLenum target, GLenum pname, const GLfloat * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnvi(GLenum target, GLenum pname, GLint param) {
    LOAD_GLES(glTexEnvi);
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnviv(GLenum target, GLenum pname, const GLint * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnvx(GLenum target, GLenum pname, GLfixed param) {
    LOAD_GLES(glTexEnvx);
...
EXPORT void APIENTRY_GL4ES gl4es_glTexEnvxv(GLenum target, GLenum pname, const GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid * data) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexParameterx(GLenum target, GLenum pname, GLfixed param) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexParameterxv(GLenum target, GLenum pname, const GLfixed * params) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * data) {
...
EXPORT void APIENTRY_GL4ES gl4es_glTranslatex(GLfixed x, GLfixed y, GLfixed z) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform1f(GLint location, GLfloat v0) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform1fv(GLint location, GLsizei count, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform1i(GLint location, GLint v0) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform1iv(GLint location, GLsizei count, const GLint * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform2f(GLint location, GLfloat v0, GLfloat v1) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform2fv(GLint location, GLsizei count, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform2i(GLint location, GLint v0, GLint v1) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform2iv(GLint location, GLsizei count, const GLint * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform3fv(GLint location, GLsizei count, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform3i(GLint location, GLint v0, GLint v1, GLint v2) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform3iv(GLint location, GLsizei count, const GLint * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform4fv(GLint location, GLsizei count, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniform4iv(GLint location, GLsizei count, const GLint * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniformMatrix2fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const GLfloat * value) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib1f(GLuint index, GLfloat x) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib1fv(GLuint index, const GLfloat * v) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib2f(GLuint index, GLfloat x, GLfloat y) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib2fv(GLuint index, const GLfloat * v) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib3f(GLuint index, GLfloat x, GLfloat y, GLfloat z) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib3fv(GLuint index, const GLfloat * v) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
...
EXPORT void APIENTRY_GL4ES gl4es_glVertexPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer) {
