...
EXPORT GLboolean APIENTRY_GL4ES glIsList(GLuint list);
EXPORT GLuint APIENTRY_GL4ES glGenLists(GLsizei range);
EXPORT void APIENTRY_GL4ES glActiveTextureARB(GLenum texture);
EXPORT void APIENTRY_GL4ES glArrayElement(GLint i);
EXPORT void APIENTRY_GL4ES glBegin(GLenum mode);
EXPORT void APIENTRY_GL4ES glCallList(GLuint list);
EXPORT void APIENTRY_GL4ES glCallLists(GLsizei n, GLenum type, const GLvoid *lists);
EXPORT void APIENTRY_GL4ES glClearDepth(GLdouble depth);
EXPORT void APIENTRY_GL4ES glDeleteList(GLuint list);
EXPORT void APIENTRY_GL4ES glDeleteLists(GLuint list, GLsizei range);
EXPORT void APIENTRY_GL4ES glDrawArrays(GLenum mode, GLint first, GLsizei count);
EXPORT void APIENTRY_GL4ES glEnd(void);
EXPORT void APIENTRY_GL4ES glEndList(void);
EXPORT void APIENTRY_GL4ES glFrustum(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble Near, GLdouble Far);
EXPORT void APIENTRY_GL4ES glGetDoublev(GLenum pname, GLdouble *params);
EXPORT void APIENTRY_GL4ES glIndexf(GLfloat i);
EXPORT void APIENTRY_GL4ES glInterleavedArrays(GLenum format, GLsizei stride, const GLvoid *pointer);
EXPORT void APIENTRY_GL4ES glListBase(GLuint base);
EXPORT void APIENTRY_GL4ES glLockArraysEXT(GLint first, GLsizei count);
EXPORT void APIENTRY_GL4ES glNewList(GLuint list, GLenum mode);
EXPORT void APIENTRY_GL4ES glOrtho(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble Near, GLdouble Far);
EXPORT void APIENTRY_GL4ES glSecondaryColor3f(GLfloat r, GLfloat g, GLfloat b);
EXPORT void APIENTRY_GL4ES glTexCoord2f(GLfloat s, GLfloat t);
EXPORT void APIENTRY_GL4ES glUnlockArraysEXT(void);
EXPORT void APIENTRY_GL4ES glVertex2f(GLfloat x, GLfloat y);
EXPORT void APIENTRY_GL4ES glVertex2i(GLint x, GLint y);
EXPORT void APIENTRY_GL4ES glVertex3f(GLfloat x, GLfloat y, GLfloat z);
EXPORT GLenum APIENTRY_GL4ES glGetError(void);
